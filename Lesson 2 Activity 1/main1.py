...
#Initialize colorama for colored outputh
colorama.init()
...
if not user_name:
    user_name = "Mystery Agent" # Fallback if user doesn't provide any name

#Store converstion as a list of tuples : (text, polarity, sentiment_type)
